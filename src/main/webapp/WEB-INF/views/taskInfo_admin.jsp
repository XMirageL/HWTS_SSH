                                    ...
                                    <form action="#" role="form" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7" id="teachers">
                                                <input id="sendEmail" type="button" class="btn btn-sm btn-info" data-toggle="tooltip"
                                                       data-placement="top" title="发送邮件给相应老师"value="发邮件" style="float: right;">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <center>
                                            <div class="col-lg-7">
                                                <input id="editInfo" type="button" class="btn btn-info" value="编辑" style="margin-right: 20px">
                                                <input id="saveInfo" type="button" class="btn btn-info" value="保存" disabled="disabled">
                                            </div>
                                            </center>
                                        </div>
