        ...
        <div id="sidebar-scroll" style="overflow: hidden; width: auto; height: 516px;">
            ...
            <div class="sidebar-content">
                ...
                <ul class="sidebar-nav">
                    <li>
                        <a id="user" href="/user" <% if (url.equals("/WEB-INF/views/user.jsp")){%>class="active" <%}%>><i
                                class="fa fa-child sidebar-nav-icon"></i><span
                                class="sidebar-nav-mini-hide">用户中心</span></a>
                    </li>
                    <li>
                        <a id="adminissue" href="/userplan" <% if (url.equals("/WEB-INF/views/userplan.jsp")){%>class="active" <%}%>><i
                                class="fa fa-calendar-check-o sidebar-nav-icon"></i><span
                                class="sidebar-nav-mini-hide">工作进度</span></a>
                    </li>
                    <li>
                        <a id="taskkind" href="/taskInfo_list" <% if (url.equals("/WEB-INF/views/taskInfo_list.jsp")){%>class="active" <%}%>><i
                                class="fa fa-list sidebar-nav-icon"></i><span
                                class="sidebar-nav-mini-hide">任务列表</span></a>
                    </li>
                    <li>
                        <a id="help" href="/userinfo" <% if (url.equals("/WEB-INF/views/userinfo.jsp")){%>class="active" <%}%>><i
